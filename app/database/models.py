...
class Schedule(Base):
    ...
    teacher_review = Column(Text)
    next_homework = Column(Text)
    suggested_pieces = Column(Text)
...
class Waitlist(Base):
    ...
    notify_source = Column(String(30))
    created_at = Column(DateTime, default=datetime.now)
...
class Archive(Base):
    ...
    teacher_style = Column(String(200))
    student_style = Column(String(100))
    student_level = Column(String(50))
    student_exam_level = Column(String(50))
...
class RecommendationLog(Base):
    ...
    saved_as_match = Column(Boolean, default=False)
    style_weight = Column(Float, default=0.30)
    rating_weight = Column(Float, default=0.25)
    level_weight = Column(Float, default=0.25)
    availability_weight = Column(Float, default=0.10)
    experience_weight = Column(Float, default=0.10)
